                ...
                <div className="space-y-4">
                  <div className="bg-white/5 rounded-lg p-3 border border-white/10">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <code className="text-gray-300 font-mono text-sm">C:\Program Files\OpenVPN\config\</code>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-lg p-3 border border-white/10">
                    ...
                    <code className="text-green-400 font-mono text-sm">sudo openvpn --config /path/to/your-profile.ovpn</code>
                  </div>
